...
public class Robot extends TimedRobot {
  ...
  public static final HatchIntake hatchintake = new HatchIntake(RobotMap.centerS, RobotMap.clawS, RobotMap.dropperS, RobotMap.grabberS,RobotMap.grabberS2,RobotMap.centerS2);
